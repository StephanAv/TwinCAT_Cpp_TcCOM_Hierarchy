...
class CVersionedCppCtrl : public ITcOCFCtrlImpl<CVersionedCppCtrl, CVersionedCppClassFactory>
{
public:
	CVersionedCppCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("VersionedCpp: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CVersionedCppCtrl>;
